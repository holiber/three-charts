var demoApp = function(modules) {
    ...
    var TrendsMarksPlugin_2 = __webpack_require__(35);
    var chart;
    ...
    var MarksSource = function() {
        ...
        MarksSource.generate = function(val) {
            ...
            var orientation = src_1.Utils.getRandomItem([ TrendsMarksPlugin_1.TREND_MARK_SIDE.TOP, TrendsMarksPlugin_1.TREND_MARK_SIDE.BOTTOM ]);
    ...
    window.onload = function() {
        ...
        }, document.querySelector(".chart"), [ new TrendsMarksPlugin_2.TrendsMarksPlugin({
        ...
        mainTrend.onDataChange(function() {
            ...
            if (markOptions) setTimeout(function() {
                var trendsMarks = chart.state.getPlugin(TrendsMarksPlugin_2.TrendsMarksPlugin.NAME);
    ...
    var Utils_1 = __webpack_require__(16);
    var Trend_1 = __webpack_require__(19);
    var Plugin_1 = __webpack_require__(36);
